...
echo '
  <script>const BASE_URL = "' . BASE_PATH . '";</script>
  ...
  <script src="' . BASE_PATH . 'assets/js/helpers/letters-only.js"></script>
  <script src="' . BASE_PATH . 'assets/js/helpers/name-validation.js"></script>
';
...
if(!empty($userId)){
  echo '
    ...
    <script src="' . BASE_PATH . 'assets/js/events.js?v=' . time() . '"></script>
