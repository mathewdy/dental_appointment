...
if(isset($_POST['send_email']))
{
    ...
    $mail = "
      ...
      <br></br>
      <a href='http://" . $_SERVER['SERVER_NAME'] . "/auth/password-reset.php?token=$token&$email"."'>Click me</a>
      ";
    ...
    if(mysqli_num_rows($check_email_run) > 0){
        ...
        if($update_token_run){
          ...
          echo "<script> success('Please Check Your Email Address.', () => window.location.href='login.php') </script>";
        }
