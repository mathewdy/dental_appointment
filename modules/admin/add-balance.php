...
if(isset($_POST['add_balance'])){
  ...
  $remaining_balance = $_POST['balance'];
  ...
  if($run_insert_payment){
    createNotification($conn, $user_id, $trans_id, "Initial Balance Added", "Payment", $id);
    createNotification($conn, $id, $trans_id, "Initial Balance Added", "Payment", $id);
