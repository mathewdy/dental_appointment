...
if(isset($_POST['add_balance'])){
  ...
  if($run_insert_payment){
    createNotification($conn, $user_id, $trans_id, "Initial Balance Added", "Payment", $dateTime, $id);
    createNotification($conn, $id, $trans_id, "Initial Balance Added", "Payment", $dateTime, $id);
