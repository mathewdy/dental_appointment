                                    ...
                                    if (isset($_GET['user_id_patient'])) {
                                        ...
                                        foreach ($all_dentists as $row_dentist) {
                                            ...
                                            <form action="" method="GET">
                                                <tr>
                                                    <td><?php echo "Dr. " . $row_dentist['first_name'] . " " . $row_dentist['last_name'] ?>
                                                    </td>
                                                    <td><?php echo formatDentistScheduleDisplay($conn, $row_dentist['user_id']); ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="set-schedule.php?user_id_dentist=<?= $row_dentist['user_id']; ?>&user_id_patient=<?= $user_id_patient; ?>"
