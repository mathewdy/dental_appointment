...
//errors - comment out for production
                ...
                <div class="page-header">
                    <div class="d-flex align-items-center gap-4 w-100">
                        ...
                        <div class="d-flex align-items-center gap-2 me-auto">
                            ...
                            <div class="nav-item">
                                <a href="#" class="text-decoration-none text-truncate text-muted">Patients</a>
                            </div>
                        </div>
                        <a href="add-patient.php" class="btn btn-sm btn-dark op-7 d-none d-md-block">Add New Patient</a>
                    </div>
                </div>
                <div class="page-category">
                    <div class="text-end mb-3">
                        <a href="add-patient.php" class="btn btn-sm btn-dark op-7 d-block d-md-none">Add New Patient</a>
                    </div>
                    <div class="card p-4">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($run_patients) > 0) {
                                        foreach ($run_patients as $row_patients) {
                                            ...
                                            <tr>
                                                <td><?php echo $row_patients['user_id'] ?></td>
                                                <td><?php echo $row_patients['first_name'] . " " . $row_patients['last_name'] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="dropdown">
                                                            <a class="btn btn-sm btn-outline-primary rounded-circle d-flex justify-content-center align-items-center dropdownToggler"
                                                                style="width: 12px;" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="fas fa-ellipsis-v"></i>
                                                            </a>
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item fs-6 fw-bold"
                                                                        href="edit-patient.php?user_id=<?php echo $row_patients['user_id'] ?>"
                                                                        class="dropdown-item">Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item delete fs-6 fw-bold" href="#"
                                                                        data="delete-patient.php?user_id=<?php echo $row_patients['user_id'] ?>">Delete</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item fs-6 fw-bold"
                                                                        href="set-doctor.php?user_id_patient=<?php echo $row_patients['user_id'] ?>">Set
                                                                        Appointment</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item fs-6 fw-bold"
                                                                        href="view-patient-medical-history.php?user_id=<?php echo $row_patients['user_id'] ?>">Medical
                                                                        History</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item fs-6 fw-bold"
                                                                        href="view-patient-treatment-history.php?user_id=<?php echo $row_patients['user_id'] ?>">Treatment
                                                                        History</a>
                                                                </li>
