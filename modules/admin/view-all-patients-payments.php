                    ...
                    <span class="d-flex justify-content-between align-items-center w-100">
                        <span class="d-flex">
                            ...
                            <ul class="breadcrumbs d-flex justify-items-center align-items-center">
                                ...
                                <li class="nav-item">
                                    <a
                                        href="view-patient-payments.php?user_id=<?php echo $user_id ?>&concern=<?php echo $concern ?>">View</a>
                                </li>
                                <li class="separator">
                                    <i class="icon-arrow-right"></i>
                                </li>
                    ...
                    if (mysqli_num_rows($run_patient_name) > 0) {
                        foreach ($run_patient_name as $row_patient_name) {
                            ...
                            <span>
                                ...
                                <h1 class="m-0 p-0">
                                    <?php echo $row_patient_name['first_name'] . " " . $row_patient_name['last_name'] ?></h1>
                            </span>
                                            ...
                                            if (isset($_GET['payment_id']) & isset($_GET['service']) & isset($_GET['user_id'])) {
                                                ...
                                                if (mysqli_num_rows($run_all_history) > 0) {
                                                    foreach ($run_all_history as $row_history) {
                                                        ...
                                                        <tr>
                                                            <td><?php echo $row_history['session_label'] ?? '-' ?></td>
