            ...
            <div class="page-category">
                <div class="card p-4">
                    ...
                    <table id="dataTable" class="display table table-striped table-hover">
                        ...
                        <tbody>
                        <?php
                            $run_patients = getPatientsByDoctor($conn, $userId);
                                          ...
                                          <div class="d-flex justify-content-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu"> 
                                                  ...
                                                  <li>
                                                    <a class="dropdown-item fs-6 fw-bold" href="view-patient-treatment-history.php?user_id=<?php echo $row_patients['user_id']?>">Treatment History</a>
                                                  </li>
                                                  <li>
                                                    <a class="dropdown-item fs-6 fw-bold" href="../admin/dental-chart.php?user_id=<?php echo $row_patients['user_id']?>">Dental Chart</a>
                                                  </li>
                                                </ul>
                                            </div>
                                          </div>
