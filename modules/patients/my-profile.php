                ...
                <div class="page-category">
                    ...
                    if(mysqli_num_rows($run_profile) > 0){
                        foreach($run_profile as $row_profile){
                            ...
                            $stmt_med = $conn->prepare("SELECT * FROM medical_history WHERE user_id = ?");
                            $stmt_med->bind_param("s", $user_id);
                            $stmt_med->execute();
                            $result_med = $stmt_med->get_result();
                            $med_history = $result_med->fetch_assoc();
                            $stmt_med->close();
                            ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 my-4">
                                                ...
                                                <div class="row align-items-center w-100">
                                                    <div class="col-4"><p class="h5 text-truncate">Phone: </p></div>
                                                    <div class="col-8"><p class="h6"><?= $row_profile['mobile_number']?></p></div>
                                                </div>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-4"><p class="h5">Email: </p></div>
                                                    <div class="col-8 "><p class="h6 text-truncate"><?= $row_profile['email']?></p></div>
                                                </div>

                                                <br>
                                                <p class="text-muted">BASIC INFORMATION</p>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5 text-truncate">Birthday: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $row_profile['date_of_birth']?></p></div>
                                                </div>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5 text-truncate">Address: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $row_profile['address'] ?? 'N/A'?></p></div>
                                                </div>

                                                <br>
                                                <p class="text-muted">MEDICAL HISTORY</p>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5">History: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $med_history['history'] ?? 'None' ?></p></div>
                                                </div>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5">Current Medications: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $med_history['current_medications'] ?? 'None' ?></p></div>
                                                </div>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5">Allergies: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $med_history['allergies'] ?? 'None' ?></p></div>
                                                </div>
                                                <div class="row align-items-center w-100">
                                                    <div class="col-lg-4"><p class="h5">Past Surgeries: </p></div>
                                                    <div class="col-lg-8 "><p class="h6"><?= $med_history['past_surgeries'] ?? 'None' ?></p></div>
                                                </div>
