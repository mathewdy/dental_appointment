                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($run_appointments) > 0) {
                                        foreach ($run_appointments as $row_appointment) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $row_appointment['appointment_date'] . " " . $start . ' - ' . $end ?>
                                                </td>
                                                <td>Dr.
                                                ...
                                                <td>
                                                    ...
                                                    if ($row_appointment['confirmed'] == 0) {
                                                        ...
                                                        <div class="text-center">
                                                            <a href="request-action.php?id=<?= $row_appointment['appointment_id'] ?>&status=2"
                                                                class="status btn btn-danger">Cancel</a>
                                                        </div>
                                                        <?php
                                                    } else {
                                                        ?>
