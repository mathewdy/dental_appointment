...
WHERE appointments.user_id_patient =  '$userId' AND appointments.appointment_date = '$formattedClickedDate'";
        ...
        $html .= '
         <div class="row">
            ...
            <div class="col-lg-12 text-end">
                <a href="requests.php" class="btn btn-primary">Manage Request</a>
            </div>
        </div>
        ';
        echo $html;
